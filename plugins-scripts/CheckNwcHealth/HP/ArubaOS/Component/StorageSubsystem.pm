package CheckNwcHealth::HP::ArubaOS::Component::StorageSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('WLSX-SYSTEMEXT-MIB', [
      ['storage', 'wlsxSysExtStorageTable', 'CheckNwcHealth::HP::ArubaOS::Component::StorageSubsystem::Storageory'],
  ]);
}


package CheckNwcHealth::HP::ArubaOS::Component::StorageSubsystem::Storageory;
