package CheckNwcHealth::HP::ArubaOS::Component::MemSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('WLSX-SYSTEMEXT-MIB', [
      ['memories', 'wlsxSysExtMemoryTable', 'CheckNwcHealth::HP::ArubaOS::Component::MemSubsystem::Memory'],
  ]);
}


package CheckNwcHealth::HP::ArubaOS::Component::MemSubsystem::Memory;
